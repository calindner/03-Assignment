...
input_file = "budget-data.csv"
output_file = "budget_data_1_summary.txt"

# input and output paths
csv_input_path = os.path.join(input_file)
...
with open(txt_output_path, mode='w', newline='') as summary_txt:
    ...
    writer.writerows([
        ...
        ["Total Revenue: " + "${:,.0f}".format(revenue_sum)],
        ["Average Revenue Change: " + "${:,.0f}".format(round(avg_revenue_change))],
